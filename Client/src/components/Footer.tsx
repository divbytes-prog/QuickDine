        ...
        <footer className="w-full bg-surface-container-low border-t border-outline-variant/20 pt-20 pb-12">
            <div className="max-w-7xl mx-auto px-6 md:px-10 grid grid-cols-1 md:grid-cols-4 gap-10">
                <div className="md:col-span-1">
                    <a href="/" className="text-primary block mb-2">
                        <img src="/logo.svg" alt="QuickDine" className="h-10 mt-1.5" />
                    </a>
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <a
                        href="mailto:24DCS032@lnmiit.ac.in"
                        className="text-sm text-black/55 hover:text-secondary transition-colors break-all"
                    >
                ...
                <div className="flex gap-6">
                    {bottomLinks.map((link) => (
                        <a
                            key={link.label}
                            href={link.path}
                            className="text-xs text-black/55 hover:text-secondary transition-colors"
                        >
                            {link.label}
                        </a>
                    ))}
