...
export default function RestaurantHero({ restaurant }: RestaurantHeroProps) {
    ...
    return (
        <section className="relative h-[480px] w-full overflow-hidden text-left animate-in fade-in duration-500">
            <img src={restaurant.image || assets.default_restaurant_img} alt={restaurant.name} className="w-full h-full object-cover brightness-[0.7]" />
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-4 text-white/90 text-xs">
                            <div className="flex items-center gap-1 text-secondary-container">
                                ...
                                <span className="font-medium text-white">{Number(restaurant.rating || 0).toFixed(1)}</span>
                            </div>
                            <span>•</span>
                            <span>{Number(restaurant.reviewCount || 0)} Reviews</span>
                            <span>•</span>
